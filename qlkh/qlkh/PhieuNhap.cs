...
namespace qlkh
{
    public partial class PhieuNhap : DevExpress.XtraEditors.XtraForm
    {
        ...
        public PhieuNhap()
        {
            ...
            //cách sửa lỗi là để hàm load này được gọi sau khi tạo ct mới :((

            //InitializeComponent();
            //// This line of code is generated by Data Source Configuration Wizard
            //// Instantiate a new DBContext
            //// Call the Load method to synchronously get the data for the given DbSet from the database.
            //dbContext.HHTrongKhoes.Where(a => a.ChungTu == commons.ct.ChungTu1).Load();
            // Bind data to control when loading complete
            //hHTrongKhoesBindingSource.DataSource = dbContext.HHTrongKhoes.Local.ToBindingList();
        }
